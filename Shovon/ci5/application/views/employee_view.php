...
<body>
    ...
    <div class="row">
        ...
        echo form_open("http://localhost/ci5/index.php/employee", $attributes);?>
        <fieldset>
            ...
            <div class="col-lg-8 col-sm-8">
                <input id="start_time" name="start_time" placeholder="start_time i.e. 10:30pm April 15 2014" type="text" class="form-control"  value="<?php echo set_value('start_time'); ?>" />
            ...
            <div class="col-lg-8 col-sm-8">
                <input id="end_time" name="end_time" placeholder="end_time i.e. 10:30pm April 15 2014" type="text" class="form-control"  value="<?php echo set_value('end_time'); ?>" />
            ...
            <div class="col-lg-8 col-sm-8">
                <input id="language" name="language" placeholder="language" type="text" class="form-control" value="<?php echo set_value('language'); ?>" />
